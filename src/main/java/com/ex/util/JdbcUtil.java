...
public class JdbcUtil {
    ...
    public static final String URL = "jdbc:mysql://localhost:3306/test1?allowPublicKeyRetrieval=true&useUnicode=true&characterEncoding=utf8&characterSetResults=utf8&useSSL=false";
